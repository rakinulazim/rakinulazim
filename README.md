...
- 🌐 **Full-Stack Web Development** — Python, Django, React, JavaScript, REST APIs
- 🔌 **WordPress Development** — Custom plugin & theme development from scratch
- 🤖 **AI Automation Engineering** — Voice agents, AI receptionists, workflow automation with n8n
- 🔗 **System Integration** — Connecting APIs, CRMs, Google Workspace, and third-party tools
